  ...
  return (
        <div>
            <div className="fixed top-0 left-0 w-full h-full bg-white overflow-y-auto">
                    <BsArrowLeftCircle className="text-3xl mx-3 my-5 cursor-pointer" onClick={toggle}/>
                    ...
                    <div className='flex justify-center items-center min-h-screen mt-5'>
                        <div className="flex space-between lg:px-28 px-10 gap-24 my-5 flex-col lg:flex-row" >
                        <div className="shadow-md px-3 py-4 w-320">
                        ...
                        <div className="shadow-md px-3 py-6 w-320 lg:w-350 h-full">
